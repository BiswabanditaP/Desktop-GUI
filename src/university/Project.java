...
public class Project extends JFrame implements ActionListener{
    Project(){
        ...
        ImageIcon ic = new ImageIcon(ClassLoader.getSystemResource("icon/third.jpg"));
        ...
        ImageIcon icon4 = new ImageIcon(ClassLoader.getSystemResource("icon/icon3.png")); /*put your student details image here*/
        ...
        ImageIcon icon5 = new ImageIcon(ClassLoader.getSystemResource("icon/icon4.jpg"));
        ...
        ImageIcon icon23 = new ImageIcon(ClassLoader.getSystemResource("icon/icon14.jpg")); /*put your faculty details image here*/
        ...
        ImageIcon icon25 = new ImageIcon(ClassLoader.getSystemResource("icon/icon15.png")); /*put your faculty details image here*/
        ...
        ImageIcon icon27 = new ImageIcon(ClassLoader.getSystemResource("icon/icon15.png")); /*put your faculty details image here*/
        ...
        ImageIcon icon29 = new ImageIcon(ClassLoader.getSystemResource("icon/icon14.jpg")); /*put your faculty details image here*/
        ...
        ImageIcon icon30 = new ImageIcon(ClassLoader.getSystemResource("icon/icon16.png")); /*put your faculty details image here*/
        ...
        ImageIcon icon32 = new ImageIcon(ClassLoader.getSystemResource("icon/icon17.png")); /*put your faculty details image here*/
        Image image33 = icon5.getImage().getScaledInstance(25,25,Image.SCALE_DEFAULT);
        ...
        ImageIcon icon7 = new ImageIcon(ClassLoader.getSystemResource("icon/icon5.png")); /*put your faculty details image here*/
        ...
        ImageIcon iconn = new ImageIcon(ClassLoader.getSystemResource("icon/icon6.png")); /*put your faculty details image here*/
        ...
        JMenuItem s2 = new JMenuItem("Student Fee Forms");
        fee.setForeground(Color.BLUE);

        s1.setFont(new Font("monospaced",Font.BOLD,16));
        ImageIcon icon14 = new ImageIcon(ClassLoader.getSystemResource("icon/icon7.png")); /*put your faculty details image here*/
        ...
        ImageIcon icon16 = new ImageIcon(ClassLoader.getSystemResource("icon/icon8.png")); /*put your faculty details image here*/
        Image image17 = icon16.getImage().getScaledInstance(25,25,Image.SCALE_DEFAULT);
        ...
        ImageIcon icon18 = new ImageIcon(ClassLoader.getSystemResource("icon/icon9.png")); /*put your faculty details image here*/
        ...
        ImageIcon icon20 = new ImageIcon(ClassLoader.getSystemResource("icon/icon10.png")); /*put your faculty details image here*/
        ...
        ImageIcon icon10 = new ImageIcon(ClassLoader.getSystemResource("icon/icon11.png")); /*put your faculty details image here*/
        ...
        ImageIcon icon11 = new ImageIcon(ClassLoader.getSystemResource("icon/icon12.png")); /*put your faculty details image here*/
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(msg.equals("New Student Admission")){
        ...
        } else if (msg.equals("Student Fee Forms")){
            ...
            try {Runtime.getRuntime().exec("c:\\Program Files (x86)\\Microsoft\\Edge\\Application\\msedge.exe");
        }catch (Exception e){ }
